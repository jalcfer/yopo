...
class SelectUserFromReceivePayment extends Component {
    ...
    return (
      <View style={[styles.container,styles.BgSelectUser]}>
        ...
        <ScrollView style={styles.contentContainer}>
          ...
          <TouchableOpacity style={styles.button}  onPress={() => this.goReceivePayment()}>
            <Text style={styles.btnText}>RECIBIR PAGO</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
    );
...
export default connect(mapStateToProps, mapDispatchToProps)(SelectUserFromReceivePayment);
